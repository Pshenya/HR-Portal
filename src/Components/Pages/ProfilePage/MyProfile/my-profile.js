            ...
            <div className="profile-content">
                <Form name="form" onSubmit={this.handleSubmit}>
                        ...
                        <div className="profile-blockContent profile-flex">
                            <div className="profile-data">
                                ...
                                <Form.Group as={Row}>
                                    ...
                                    <Col sm={10}>
                                        <Form.Control as="select" name="workExperience" value={profile.workExperience}
                    ...
                    <div className="profile-save-data">
                        ...
                        {!loading  && <div>
                        <MDBIcon far icon="check-circle" size="2x" style={{margin: '10px 0 0 10px', color: 'limegreen'}} />
                        </div>}
                    </div>
                </Form>
